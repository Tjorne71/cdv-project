      ...
      <svg height={height} width={width}>
        ...
        <g fill="none" stroke="none" strokeLinejoin="round" strokeLinecap="round">
          ...
          {usData.objects.states.geometries.map((state) => {
            ...
            return (
              <text key={state.id} x={centroid[0]} y={centroid[1]} textAnchor="middle" dominantBaseline="central" fill="black" fontSize="6px" stroke="white" strokeWidth={1} strokeOpacity={0.8} className="font-Montserrat" paintOrder="stroke">
        ...
        >
          <Box sx={style}>
            ...
            <Typography id="modal-modal-description" sx={{ mt: 2 }}>
              ...
              <a className="text-blue-500" target="_blank" href="https://drive.google.com/file/d/1A81bOo2kZDV1A9HY4_Xo9opsrM6gnGju/view?usp=sharing">1. Monthly Fires Per County </a>
              - The sum of all fires in every county every single month from 1992-2015.
              <br/>
              <a className="text-blue-500" target="_blank" href="https://drive.google.com/file/d/1nG-w1_LU-WmriZ84J-3xZT0womRlOALH/view?usp=sharing">2. Monthly Fires in the entire US </a>
              - The sum of all fires in the United Stats every single month from 1992-2015.
              <br/><br/>
              <p>The entire dataset can be downloaded from <a className="text-blue-500" target="_blank" href="https://www.kaggle.com/datasets/rtatman/188-million-us-wildfires">Kaggle.</a></p>
              <br/>
              <h6 className="font-bold">Citation:</h6>
              <p>Short, Karen C. 2017. Spatial wildfire occurrence data for the United States, 1992-2015 [FPA_FOD_20170508]. 
              4th Edition. Fort Collins, CO: Forest Service Research Data Archive. https://doi.org/10.2737/RDS-2013-0009.4</p>
            </Typography>
          </Box>
        </Modal>
      </div>
