      ...
      <div className="text-2xl p-8 bg-[#3D5E70] flex flex-col h-auto w-3/7">
        ...
        <div className="mt-auto">
          <h2 className="mb-4 bg-[#3b5665] p-3 text-lg">
            {isSentenceVisible ? generateCompleteFireSentence(focusMonth, focusYear, focusCounty, fireTotal, fireSentence.sentence) : "Click on a county too see county specific fires."} {fireSentence ? <ImageTip imageUrl={fireSentence.image} sentence={fireSentence.sentence}/> : <></> } 
          </h2>
          {showYearlyGraph ? (
            <>
