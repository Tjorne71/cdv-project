...
export default function Visual() {
  ...
  const right = (
    <>
      <div className="text-2xl bg-[#3D5E70] p-1 pb-3">
      ...
      <div className="mt-auto">
        <h2 className="mb-4 bg-[#3b5665] p-3 text-lg">{isSentenceVisible ? generateCompleteFireSentence(focusMonth, focusYear, focusCounty, fireTotal, fireSentence) : "Click on a county too see county specific fires."}</h2>
        {showYearlyGraph ? (
          <>
  ...
  return (
    <ThreeBoxLayout topLeft={"topLeft"} bottomLeft={"bottomLeft"} right={"right"}/>
  );
}
